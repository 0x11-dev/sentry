...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('sentry_messagefiltervalue', 'project_id', self.gf(
            'sentry.db.models.fields.bounded.BoundedBigIntegerField')(null=True))

        # Changing field 'GroupTagValue.group_id'
        db.alter_column('sentry_messagefiltervalue', 'group_id', self.gf(
            'sentry.db.models.fields.bounded.BoundedBigIntegerField')())

        # Changing field 'CommitFileChange.filename'
        db.alter_column('sentry_commitfilechange', 'filename',
                        self.gf('django.db.models.fields.TextField')())

        # Changing field 'TagKey.project_id'
        db.alter_column('sentry_filterkey', 'project_id', self.gf(
            'sentry.db.models.fields.bounded.BoundedBigIntegerField')())
        ...
        db.alter_column('sentry_grouptagkey', 'project_id', self.gf(
            'sentry.db.models.fields.bounded.BoundedBigIntegerField')(null=True))

        # Changing field 'GroupTagKey.group_id'
        db.alter_column('sentry_grouptagkey', 'group_id', self.gf(
            'sentry.db.models.fields.bounded.BoundedBigIntegerField')())

        # Changing field 'TagValue.project_id'
        db.alter_column('sentry_filtervalue', 'project_id', self.gf(
            'sentry.db.models.fields.bounded.BoundedBigIntegerField')(null=True))
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'sentry_projectcficachefile', (
            ...
            ('debug_file', self.gf('sentry.db.models.fields.foreignkey.FlexibleForeignKey')(
                to=orm['sentry.ProjectDebugFile'], db_column='dsym_file_id', on_delete=models.DO_NOTHING)),
    ...
    models = {
        ...
        'sentry.apiapplication': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'default': "'32d49b3ae41047a693c77f4137add09e41ec1c2403784ff888a8f39a81dd0cda'", 'unique': 'True', 'max_length': '64'}),
            'client_secret': ('sentry.db.models.fields.encrypted.EncryptedTextField', [], {'default': "'2a485b467ce742338f35edc0c5a3d75277eda7353a70470c8f43d27583132aa4'"}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'homepage_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'Amused Gazelle'", 'max_length': '64', 'blank': 'True'}),
        ...
        'sentry.apigrant': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'b4848da17b57453d9f32dcd4edba0f14'", 'max_length': '64', 'db_index': 'True'}),
            'expires_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2019, 5, 17, 0, 0)', 'db_index': 'True'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
        ...
        'sentry.apitoken': {
            ...
            'application': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.ApiApplication']", 'null': 'True'}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'expires_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2019, 6, 16, 0, 0)', 'null': 'True'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
            'refresh_token': ('django.db.models.fields.CharField', [], {'default': "'5650272cadde408fa4a6d6912de49ecd64e2ff2b42e8464aaab06811412d0226'", 'max_length': '64', 'unique': 'True', 'null': 'True'}),
            'scope_list': ('sentry.db.models.fields.array.ArrayField', [], {'of': (u'django.db.models.fields.TextField', [], {})}),
            'scopes': ('django.db.models.fields.BigIntegerField', [], {'default': 'None'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'bde58bb097aa443da2bda2a84c714844ebaafefd5f4d4b018dd1b1a5a8715d15'", 'unique': 'True', 'max_length': '64'}),
            'user': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.User']"})
        },
        ...
        'sentry.broadcast': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'date_expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2019, 5, 24, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
        ...
        'sentry.groupshare': {
            ...
            'project': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.Project']"}),
            'user': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.User']", 'null': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'6a2bb26c2cf840bca9506c1f39255785'", 'unique': 'True', 'max_length': '32'})
        },
        'sentry.groupsnooze': {
        ...
        'sentry.scheduleddeletion': {
            ...
            'data': ('jsonfield.fields.JSONField', [], {'default': '{}'}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'date_scheduled': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2019, 6, 16, 0, 0)'}),
            'guid': ('django.db.models.fields.CharField', [], {'default': "'ba3b275ff94448c5ab10a0e5a681e03c'", 'unique': 'True', 'max_length': '32'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
        ...
        'sentry.sentryapp': {
            ...
            'status': ('sentry.db.models.fields.bounded.BoundedPositiveIntegerField', [], {'default': '0', 'db_index': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'7370f0b1-3187-4c57-9b6b-178f9b1853b3'", 'max_length': '64'}),
        ...
        'sentry.sentryappinstallation': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'f74496f8-0980-4fb0-866c-fcea34b972fd'", 'max_length': '64'})
        },
        'sentry.servicehook': {
            ...
            'project_id': ('sentry.db.models.fields.bounded.BoundedPositiveIntegerField', [], {'db_index': 'True'}),
            'secret': ('sentry.db.models.fields.encrypted.EncryptedTextField', [], {'default': "'ff42b60b122b4b24bcea43e11b32154d33a4904811614438bdec55c8775d728c'"}),
            'status': ('sentry.db.models.fields.bounded.BoundedPositiveIntegerField', [], {'default': '0', 'db_index': 'True'}),
        ...
        'sentry.useremail': {
            ...
            'validation_hash': ('django.db.models.fields.CharField', [], {'default': "u'VkrbEzAgncasd4qAeHGwg4wnlube3RrZ'", 'max_length': '32'})
        },
        'sentry.userip': {
